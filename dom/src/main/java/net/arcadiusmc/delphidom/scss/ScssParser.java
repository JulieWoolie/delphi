...
import static net.arcadiusmc.delphidom.parser.Token.HEX_ALPHA;
import static net.arcadiusmc.delphidom.parser.Token.HEX_SHORT;
import static net.arcadiusmc.delphidom.parser.Token.ID;
import static net.arcadiusmc.delphidom.parser.Token.NUMBER;
import static net.arcadiusmc.delphidom.parser.Token.SEMICOLON;
import static net.arcadiusmc.delphidom.parser.Token.SQUIG_CLOSE;
