...
public interface EventTarget {
  ...
  /**
   * Set the append listener. The listener is called when a child {@link net.arcadiusmc.dom.Node}
   ...
   * {@link net.arcadiusmc.dom.Node} is removed from the target.
   * <p>
   * Can be removed by setting this to {@code null} and overridden by calling
   * this method again
   * <p>
   ...
   * {@link net.arcadiusmc.dom.InputElement} is changed, either by player or
   * by calling the {@link net.arcadiusmc.dom.InputElement#setValue(String)}
   * method.
   * <p>
   * Can be removed by setting this to {@code null} and overridden by calling
   * this method again
