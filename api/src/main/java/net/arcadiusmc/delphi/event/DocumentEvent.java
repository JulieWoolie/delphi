...
public class DocumentEvent extends Event {
  ...
  private final net.arcadiusmc.dom.event.Event domEvent;

  public DocumentEvent(@NotNull net.arcadiusmc.dom.event.Event domEvent) {
   ...
   */
  public @NotNull net.arcadiusmc.dom.event.Event getDomEvent() {
    return domEvent;
  }
